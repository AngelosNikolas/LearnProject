...
4 Completion ratio for each step.
...
QuestionsPlot3
```
It is quite clear that similar results were produced on all runs. Meaning the changes occurred after the first run did not affect the successful quiz ratio. The first week was the most successful on all three runs. Many assumption could be derived as to why, looking into the step activity data set could shed some light.
