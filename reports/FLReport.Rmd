...
1. Success rate for every quiz.
2. Success rate based on each week.
3. Correlation regarding the material and failure rate regarding the material.

### Step activity
Step activity is particularly useful data set because it contains details about each step across the three weeks of the course. It is possible to derive results that would provide vital information on the teaching material and the reception it recieved from the learners.
...
For the question response data set 3 data frames are constructed filtered by the correct answers for the questions for each weak respectively. This will later utilized to compare performance in terms of success. Furthermore, the worst perfoming week will be annualized further.
